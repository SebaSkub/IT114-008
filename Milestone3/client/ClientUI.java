...
import Milestone3.client.views.UserListPanel;
...
public class ClientUI extends JFrame implements IClientEvents, ICardControls {
    ...
    public ClientUI(String title) {
        ...
        //UserListPanel.setPreferredSize(new Dimension((int) (this.getWidth() * .5), (int) this.getHeight()));
        //UserListPanel.setMinimumSize(UserListPanel.getPreferredSize());
    ...
    public void onReceiveOut(long clientId) {
        if (clientId == Constants.DEFAULT_CLIENT_ID) {
            return;// This is just the command to tell userListPanel to reset the out list
        }
